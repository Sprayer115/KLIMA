<template>
  <div class=" dark:text-white">
    ...
    <div class="mb-4">
      ...
      <select id="categorySelect" v-model="selectedCategory" class="border rounded p-2 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="mb-4">
      ...
      <select id="subCategorySelect" v-model="selectedSubCategory" class="border rounded p-2 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="table-container">
      <div class="table-section" v-if="Object.keys(filteredData1).length">
        ...
        <select id="periodSelect1" v-model="selectedPeriod1" @change="() => loadPeriodData(selectedPeriod1, currentData1)" class="border rounded p-2 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="table-section" v-if="Object.keys(filteredData2).length">
        ...
        <select id="periodSelect2" v-model="selectedPeriod2" @change="() => loadPeriodData(selectedPeriod2, currentData2)" class="border rounded p-2 dark:bg-gray-800 dark:border-gray-700">
          <option v-for="n in periods" :key="n" :value="String(n)">{{ n }}</option>
        </select>
        <Table class="mt-4">
